...
void _3DScene::MoveLight(int slot, float x, float y)
{
...
void _3DScene::ComputeShadowVolumeForEdge(int slot, Vector2 sp, Vector2 ep)
{
...
void _3DScene::DrawLightMask(int slot)
{
    // Use the light mask
...
// Setup a light
void _3DScene::SetupLight(int slot, float x, float y, float radius)
{
...
bool _3DScene::UpdateLight(int slot, Rectangle* boxes, int count)
{
...
// Set up some boxes
void _3DScene::SetupBoxes(Rectangle* boxes, int* count)
{
